import 'package:meu_primeiro_app/model/Anotacao.dart';
...
class AnotacaoHelper {
  ...
  _inicializarDB() async {
    ...
    final localBancodeDados = join(caminhoBancodeDados, "banco_minhas_anotacoes");
  ...
  Future<int> atualizarAnotacoes(Anotacao anotacao) async {
    var bancoDados = await db;
